                        ...
                        <div class="w-7/12 flex justify-end items-center mr-9 user-block">
                            <div class="w-full mr-4 flex">
                                <div class="parent-search-block flex-nowrap w-full flex justify-end items-center mt-1" ref="parent_search_block">
                                    ...
                                    <span v-if="showSearchText" class="text-gray-500 ml-2">Search bids</span>
                                </div>
                            </div>
                            <div class="ml-12 flex justify-end items-center relative">
                                ...
                                <p class="flex justify-center items-center cursor-pointer link-image" @click="showDropdown()">
                                    ...
                                    <img class="ml-1 mt-1 cursor-pointer" src="/images/arrow-down.svg" alt="arrow down" />
                                </p>
                                <div class="absolute top-10 left-6 w-40 bg-white rounded-2xl shadow-2xl hidden dropdown" ref="dropdown">
                                    <ul class="p-4">
                                        <li class="my-4">
                                            <a class="border-b-4 border-white hover:border-green-500" :href="route('profile.show')">Profile</a>
                                        </li>
                                        <li>
                                            <a class="border-b-4 border-white hover:border-green-500" href="#">Setting filteres</a>
                                        </li>
                                        <hr class="mt-6 mb-2 min-w-full" />
                                        <li>
                                            <a class="border-b-4 border-white hover:border-green-500" href="#">Log out</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
