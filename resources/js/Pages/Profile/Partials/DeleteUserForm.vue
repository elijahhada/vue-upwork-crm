        ...
        <template #content>
            ...
            <jet-dialog-modal :show="confirmingUserDeletion" @close="closeModal">
                ...
                <template #content>
                    ...
                    <div class="mt-4">
                        <jet-input type="password" class="mt-1 block w-3/4" placeholder="Password" ref="password" v-model="form.password" @keyup.enter="deleteUser" />
                ...
                <template #footer>
                    ...
                    <jet-danger-button class="ml-2" @click="deleteUser" :class="{ 'opacity-25': form.processing }" :disabled="form.processing"> Delete Account </jet-danger-button>
                </template>
            </jet-dialog-modal>
        </template>
    </jet-action-section>
