<template>
    <section id="manager-filters" class="w-full bg-white p-8  min-h-screen z-50 absolute top-0 left-0 right-0">
        ...
        <div class="mb-10">
            ...
            <div class="flex flex-wrap justify-content-start items-start">
                ...
                <button
                    ...
                    v-bind:class="{'bg-green-500 text-white': category.checked}"
                >
                    {{category.title}}
                </button>
            </div>
